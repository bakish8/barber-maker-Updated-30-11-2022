...
const TermsandConditaions = ({ history }) => {
  return (
    <>
      <div className='PrivecyPolicy'>
        <h1 className='PrivtePolicyH1'>Terms and conditions</h1>
        ...
        <h2 className='PrivtePolicyH2'>Accounts and membership</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>User content</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Backups</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Prohibited uses</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Intellectual property rights</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Limitation of liability</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Indemnification</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Severability</h2>
        <p className='PrivtePolicyP'>
        ...
        <h2 className='PrivtePolicyH2'>Dispute resolution</h2>
        <p className='PrivtePolicyP'>
          ...
          and procedural laws of Israel without regard to its rules on conflicts
          or choice of law and, to the extent applicable, the laws of Israel.
          The exclusive jurisdiction and venue for actions related to the
          subject matter hereof shall be the courts located in Israel, and you
          hereby submit to the personal jurisdiction of such courts. You hereby
          waive any right to a jury trial in any proceeding arising out of or
          related to this Agreement. The United Nations Convention on Contracts
        ...
        <h2 className='PrivtePolicyH2'>Acceptance of these terms</h2>
        <p className='PrivtePolicyP'>
...
export default TermsandConditaions
