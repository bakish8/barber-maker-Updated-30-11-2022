...
const ClientEffect = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: 'משלם 200 ש"ח בחודש שזה עלות של 4 לקוחות שמסתפרים אצלי ,אני מספר בחודש בין 300 ל-400 לקוחות ,השקעה של 1% מההכנסות של העסק למערכת שתנהל את הכל וגם תחסוך לכם את המזכירה הזמן שלכם חשוב, שווה את הכסף',
    },
    {
      name: 'רפי כהן',
      position: 'ספר',
