  ...
  const testimonials = [
    {
      ...
      text: 'מממליץ בחום!, יש לי זמן לשתות קפה , כולם באים בזמן ואני מתעסק בלספר אנשים היום אני גם מוכר מוצרים דרך האתר שלי',
    },
    {
      ...
      text: 'משלם 200 ש"ח בחודש שזה עלות של 4 לקוחות שמסתפרים אצלי ,אני מספר בחודש בין 300 ל-400 לקוחות ,השקעה של 1% מההכנסות של העסק למערכת שתנהל את הכל וגם תחסוך לכם את המזכירה,',
    },
    {
      name: 'רפי כהן',
      position: 'ספר',
